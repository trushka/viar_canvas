...
// Created by Webicon
// Credits by Gsap
// This script originaly creadted by Gsap and this is one only modified by webicon
// All right reserved to Gsap
    ...
    "tHPN": [function (require, module, exports) {
      ...
      var ButtonCtrl = /*#__PURE__*/ function (_EventEmitter) {
        ...
        function ButtonCtrl(el) {
          ...
          _this.DOM.text = _this.DOM.el.querySelector('.button-text');
          _this.DOM.textinner = _this.DOM.el.querySelector('.button-text-inner');
          _this.DOM.deco = _this.DOM.el.querySelector('.button-deco');
          _this.DOM.filler = _this.DOM.deco.querySelector('.button-filter'); // amounts the button will translate/scale
